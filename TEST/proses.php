...
// 5. Menu makanan berdasarkan kebutuhan kalori
...
<body>
  <div class="container">
    ...
    <p>
      Kalori × Faktor Aktivitas (<?= $aktivitas ?>) = <?= round($bmr) ?> × <?= $aktivitas ?> = <strong><?= round($kalori_sebelum_tujuan) ?> kkal</strong>
    </p>

    <p><strong>3. Penyesuaian Tujuan:</strong></p>
    <p>
      <?= $teks_tujuan ?> → Kalori akhir: <strong><?= round($kalori_akhir) ?> kkal</strong>
    </p>
